...
ActiveRecord::Schema[7.0].define(version: 2023_09_19_202947) do
  create_table "menu_items", force: :cascade do |t|
    ...
    t.index ["name", "restaurant_id", "price"], name: "index_menu_items_on_name_and_restaurant_id_and_price", unique: true
